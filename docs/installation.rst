...
To install pysteps-importer-cwb, run this command in your terminal:

.. code-block:: console

    $ pip install pysteps_importer_cwb
...
The latest development version of pysteps-importer-cwb can be installed using
pip by running in a terminal::

    pip install git+https://github.com/YOUR_GITHUB_USERNAME/pysteps-importer-cwb

Or, from a local copy of the repo::

    git clone https://github.com/YOUR_GITHUB_USERNAME/pysteps-importer-cwb
    cd pysteps-importer-cwb
    pip install .
